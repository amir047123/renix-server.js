...
const sendEmail = async (recipient, emailType, data, cb) => {
  let transporter = nodemailer.createTransport({
    ...
    requireTLS: true,
    auth: {
      user: "organicherbalofficial@gmail.com",
      pass: "utwnxkxukkelleng", //Usually email senders app password will be inserted here, I am removing mine for my security purpose.
    },
    tls: {
      ciphers: "SSLv3",
    },
  ...
  let mailOptions = {
    from: "organicherbalofficial@gmail.com", // sender address
